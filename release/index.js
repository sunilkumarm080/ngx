...
var GaugeArcComponent = (function () {
    ...
    GaugeArcComponent.prototype.ngOnInit = function () {
        this.coords = this.valueArc.innerRadius; //<-- this is the position of the end of the line connecting the two arcs               
        // this.transform  = `translate(${180},${240}) rotate(${-110}))`; //<-- position text and rotate it       
        // translate(${ this.coords })
        this.transform = "translate(" + -65 + "," + -110 + ") rotate(" + -120 + ")"; //<-- position text and rotate it       
        this.xval = -123;
        this.yval = (this.backgroundArc.innerRadius * -1);
    };
...
var GaugeAxisComponent = (function () {
    ...
    GaugeAxisComponent.prototype.getTicks = function () {
        ...
        var startDistance = this.radius + 5;
